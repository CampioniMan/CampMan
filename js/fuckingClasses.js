...
{ 
	...
	this.colidiuCom = function(monstro, tamanho)
	{
		...
		if ((monstro.xis <= this.xis+tamanhozinho && monstro.xis+tamanhozinho >= this.xis) && (monstro.ipi <= this.ipi + tamanhozinho && monstro.ipi + tamanhozinho >= this.ipi))
			return true;
		return false;
	}
	...
	{
		if ((monstro.xis <= this.xis+tamanho && monstro.xis+tamanho >= this.xis) && (monstro.ipi <= this.ipi + tamanho && monstro.ipi + tamanho >= this.ipi))
			return true;
		return false;
	}
